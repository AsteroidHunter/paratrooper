...
const APP_VERSION = "0.1.30-dbg"; // settings glyph → 🎛️ (the 🪂 doubled the logo in the same row)
...
function renderChat(): void {
  app.innerHTML = `
    <header class="bar">
      ...
      <div class="settings">
        <button type="button" id="settings" class="gearbtn" title="Settings">🎛️</button>
