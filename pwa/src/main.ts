...
const APP_VERSION = "0.3.115"; // The worker signs in to GitHub as Paratrooper itself with a key that expires every hour, so pull requests now come from the bot and the old personal key can be deleted
